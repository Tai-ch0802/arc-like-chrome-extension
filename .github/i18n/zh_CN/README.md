...
## 🚀 新版本 v1.11.0 更新！
[![演示视频](http://img.youtube.com/vi/Ld4lyaZatWo/0.jpg)](https://www.youtube.com/watch?v=Ld4lyaZatWo)

### ⚡️ 特色功能
- **垂直标签页**：查看完整页面标题，不再被压缩成微小的图标。
- **标签页群组**：与 Chrome 标签页群组完美整合，同步颜色与名称。
- **书籤整合**：统一的面板，同时管理标签页与书籤。
- **关联标签页**：在开启书籤时自动创建“链接”，避免重复开启。
- **跨窗口搜索**：在所有开启的窗口中搜索标签页与书籤。
- **动态渲染**：针对庞大的书籤库提供高效的渲染性能。
