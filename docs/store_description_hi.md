...
- **माइक्रो-इंटरैक्शन**: आंतरिक बटनों (जैसे बंद करें, समूह में जोड़ें) को नेविगेट करने और ट्रिगर करने के लिए `Arrow Left`/`Arrow Right` का उपयोग करें।
- **खोज एकीकरण**: खोज बार को फोकस करने के लिए सूची के शीर्ष पर `Up` दबाएं; परिणामों पर कूदने के लिए खोज बार में `Down` दबाएं।
- **फोकस टिप**: एक बार साइडबार खुला होने पर, स्वचालित रूप से फोकस हथियाने और नेविगेट करना शुरू करने के लिए बस कोई भी तीर कुंजी दबाएं।
