最新バージョン - 1.7.0
✨ 新機能
- ブックマークとタブのリンク機能：ブックマークとタブをリンクするアーク風の機能を実装しました。ブックマークをクリックしたり、タブをドラッグしてブックマークを作成すると、自動的にリンクが作成されます。ブックマークの横にリンクアイコンが表示され、クリックするとリンクされているすべてのタブが表示され、すばやく切り替えたり閉じたりできます。
- 新しいクリスマス・テーマ：ホリデーシーズンを祝うため、設定にソフトで暖かいクリスマス・テーマを追加しました。

🚀 改善とバグ修正
- ブックマークへのドラッグガード：タブをドラッグしてブックマークを作成する際、同じURLのブックマークが既に存在するかどうかをシステムがチェックし、重複を防ぐために確認ダイアログを表示するようになりました。

詳細なリリースノートについては、こちらをご覧ください：https://github.com/Tai-ch0802/arc-like-chrome-extension/releases
